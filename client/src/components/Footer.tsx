      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#faq" className="text-sm text-mtext hover:underline">
                  FAQ
                </a>
              </li>
            </ul>
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex space-x-4 mb-4">
              <a
                target="_blank"
                rel="noopener noreferrer"
                href="https://x.com/ment0san/status/1907127259569258985"
                className="text-mtext hover:text-text"
              >
                <svg
              ...
              <a
                target="_blank"
                rel="noopener noreferrer"
                href="https://github.com/omgmanu/super-predict"
                className="text-mtext hover:text-text"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="border-t-2 border-border mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <p className="text-sm text-mtext">
            Built for{' '}
            <a
              href="https://contest.superseed.xyz"
              target="_blank"
              rel="noopener noreferrer"
              className="font-bold hover:underline"
            >
              Superseed competition
            </a>
          </p>
        </div>
      </div>
